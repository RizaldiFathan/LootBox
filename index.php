        ...
        <div class="modal-body">
          <form action="" id="signup" method="POST">
            <div class="form-group">
              ...
              <input type="text" id="username" placeholder="Masukkan username" class="form-control" name="username" autofocus required>
            ...
            <div class="form-group">
              <div class="row">
                <div class="col">
                  ...
                  <input type="email" class="form-control" id="email" aria-describedby="email" placeholder="Masukkan email" name="email" autofocus required>
                </div>
                <div class="col">
